...
export function waitUntilAsync(fn_1) {
    return __awaiter(this, arguments, void 0, function* (fn, duration = defaultDuration, error = new TimeoutError("function did not complete within allowed time")) {
